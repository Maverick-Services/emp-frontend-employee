...
const Dashboard = () => {
  ...
  return (
    <div className="w-full max-[768px]:flex-col flex bg-[#F3F6FE] h-screen">
      ...
      {/* Sidebar - Responsive */}
      {/* <div
          className={`absolute md:relative z-50 transition-all duration-300 h-full ${isSidebarOpen ? "w-[250px] h-fit" : "max-md:w-[70px] w-[250px] max-md:h-0 max-md:overflow-hidden"
