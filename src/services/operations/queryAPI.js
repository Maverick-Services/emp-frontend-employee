...
export const fetchEmployeeQueries = async (data, token) => {
    ...
    try {
        ...
        // console.log("FETCH EMPLOYEE QUERIES RESPONSE:- ", response)
        // toast.success(response?.data?.message)
        return response?.data?.data;

    } catch (error) {
        console.log("FETCH EMPLOYEE QUERIES ERROR:- ", error)
        toast.error(error?.response?.data?.message || error?.message)
        return null;
    }
}
...
export const addQueryReply = async (data, token) => {
    ...
    try {
        ...
        console.log("ADD QUERY REPLY RESPONSE... ", response)
        // toast.success(response?.data?.message)
        return response?.data?.data;
